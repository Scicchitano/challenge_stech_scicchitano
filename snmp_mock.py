class snmp_mock(object):
    def inicializacion(self):
        ...
        self.softversion = ""
    def run(self,OID):
        """Se simula una respuesta en la que se le agrega los primeros 3 valores del OID para que haya alguna relacion entre el OID y las respuestas"""
        ...
        """Se extren los valores de los parametros de la respuesta"""
